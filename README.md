# Vulnerable-Web-App
The main goal of VWA is to provide a hands-on experience for security rookies of vulnerable web applications available for practicing and learning, so that they can attack realistic web environments… without going to jail :)
